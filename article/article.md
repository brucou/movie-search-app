...
You can have a look at the [final implementation with all fixes](https://codesandbox.io/s/kwn3lx2qx7) of the online interface to the movie database using dedicated state machine libraries.
