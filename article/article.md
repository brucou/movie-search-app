...
| Movie selection | ... | MOVIE_SELECTED | :white_square_button: loading screen<br>:grey_question: TMDb | ... | Movie detail querying | 
| Movie detail querying | ... | SEARCH_RESULTS_MOVIE_RECEIVED | :white_square_button: results screen | ... | Movie detail selection | 
| Movie detail selection | ... | MOVIE_DETAILS_DESELECTED | :white_square_button: results screen | ... | Movie selection | 
| Movie detail querying | ... | SEARCH_ERROR_MOVIE_RECEIVED | :white_square_button: error screen | ... | Movie detail selection error | 
